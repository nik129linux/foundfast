...
const Index = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[linear-gradient(180deg,hsl(var(--background))_0%,hsl(var(--secondary))_100%)] px-0 md:px-8">
      <div className="relative mx-auto h-screen w-full max-w-md overflow-hidden bg-background md:h-[812px] md:rounded-[34px] md:border md:border-border/70 md:shadow-[0_30px_80px_-48px_hsl(var(--primary)/0.5)]">
